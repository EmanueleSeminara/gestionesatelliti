							...
							<form:form modelAttribute="edit_satellite_attr" method="post" action="${pageContext.request.contextPath}/satellite/update" class="row g-3" novalidate="novalidate">
								...
								<div class="col-md-6">
									...
									<spring:bind path="denominazione">
										<input type="text" name="denominazione" id="denominazione" class="form-control ${status.error ? 'is-invalid' : ''}" placeholder="Inserire il denominazione" value="${edit_satellite_attr.denominazione }" required>
									</spring:bind>
								...
								<div class="col-md-3">
									<label for="dataRientro" class="form-label">Data Rientro <span class="text-danger">*</span></label>
